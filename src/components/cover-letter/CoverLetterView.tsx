          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 border border-slate-800 space-y-4 shadow-xl">
            ...
            <textarea
              ...
              value={
                ...
                `Hi ${selectedJob?.company || 'Team'} Hiring Team,\n\nI'm writing to share my background for the ${selectedJob?.title || 'Software Engineer'} role. Over the past 3.5+ years, I've spent most of my time building reliable web applications—focusing closely on React, TypeScript, and clean UI architecture.\n\nIn my recent work at Apex Cloud Solutions, I led our core frontend component system and worked on backend REST endpoints that handled high daily traffic. What really drew me to ${selectedJob?.company || 'your team'} is your practical focus on scalable engineering. I enjoy tackling performance bottlenecks, keeping codebases straightforward to maintain, and collaborating closely with product and design.\n\nI would love the chance to connect and talk through how my past experience can help support what your team is building. Thanks so much for your time and consideration.\n\nBest regards,\n${userProfile?.name || 'Alex Mercer'}\n${userProfile?.email || 'alex.mercer@example.com'} | ${userProfile?.phone || '+1 (555) 234-8901'}`
              }
